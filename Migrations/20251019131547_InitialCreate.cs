        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubAdminId = table.Column<string>(type: "varchar(255)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_SubAdmins_SubAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_SubAdmins_SubAdminId",
                        column: x => x.SubAdminId,
                        principalTable: "SubAdmins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeScheduled = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    SubAdminId = table.Column<string>(type: "varchar(255)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_SubAdmins_SubAdminId",
                        column: x => x.SubAdminId,
                        principalTable: "SubAdmins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateCreated", "Email", "FirstName", "IsDeleted", "LastName", "Password", "Role" },
                values: new object[] { "AMIN", new DateTime(2025, 10, 19, 13, 15, 46, 985, DateTimeKind.Utc).AddTicks(5050), "AminOmoyele@gmail.com", "Amin", false, "Omoyele", "$2a$10$1sK7X5E2EQWDHRw84HAwJOfM3cXkMVyg9hzqrTcuyEeK1jO6ue66O", "Administrator" });
